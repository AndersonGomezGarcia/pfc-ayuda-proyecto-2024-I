...
class TestPruebasPar3 extends AnyFunSuite{
  ...
  test("test6") {
    ...
    assert(its6.take(2) === List(List(Vuelo("4X", 373, "HOU", 13, 15, "MSY", 15, 10, 1), Vuelo("AA", 828, "MSY", 17, 10, "BNA", 18, 37, 0)), List(Vuelo("4X", 375, "HOU", 18, 20, "MSY", 10, 15, 1), Vuelo("AA", 828, "MSY", 17, 10, "BNA", 18, 37, 0)))  )  }
  ...
  test("test8") {
    ...
    assert(its8.take(2) === List(List(Vuelo("DL", 296, "PHX", 14, 25, "ATL", 19, 53, 0), Vuelo("DL", 187, "ATL", 19, 7, "LAX", 10, 55, 0)), List(Vuelo("DL", 252, "PHX", 16, 35, "DFW", 19, 48, 0), Vuelo("DL", 179, "DFW", 15, 40, "LAX", 16, 40, 0)))   )
  }

  test("test9") {
    val its9 = itsCurso100("PHX", "DTW")
    assert(its9.take(2) === List(List(Vuelo("DL", 296, "PHX", 14, 25, "ATL", 19, 53, 0), Vuelo("DL", 868, "ATL", 8, 26, "DTW", 10, 10, 0)), List(Vuelo("DL", 296, "PHX", 14, 25, "ATL", 19, 53, 0), Vuelo("DL", 714, "ATL", 23, 47, "DTW", 12, 5, 0)))  )
  }
}
